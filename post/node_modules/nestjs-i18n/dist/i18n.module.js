...
let I18nModule = I18nModule_1 = class I18nModule {
    ...
    async onModuleInit() {
        ...
        if (this.i18nOptions.viewEngine == 'hbs' ||
            ...
            try {
                const hbs = this.i18nOptions.viewEngine === 'hbs'
                    ? await Promise.resolve().then(() => require('hbs'))
                    : await Promise.resolve().then(() => require('handlebars'));
                hbs.registerHelper('t', this.i18n.hbsHelper);
                exports.logger.log('Handlebars helper registered');
            }
            catch (e) {
                exports.logger.error(this.i18nOptions.viewEngine + ' module failed to load', e);
            }
        }
    ...
    configure(consumer) {
        if (this.i18nOptions.disableMiddleware)
            return;
        consumer.apply(i18n_middleware_1.I18nMiddleware).forRoutes('*path');
